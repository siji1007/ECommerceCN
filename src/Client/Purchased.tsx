...
const TransactionsPage: React.FC = () => {
  ...
  const fetchTransactions = async () => {
    let endpoint = '';
    if (activeTab === 'To Pay') {
      endpoint = serverURL + `/api/transactions/${userId}/to_pay`;
    } else if (activeTab === 'To Receive') {
      endpoint = serverURL + `/api/transactions/${userId}/to_receive`;
    } else if (activeTab === 'Cancelled') {
      endpoint = serverURL + `/api/transactions/${userId}/cancelled`;
    }
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex border-b mb-4">
        {['To Pay', 'To Receive', 'Cancelled'].map((tab) => (
          <button
            key={tab}
      ...
      <div>
        ...
        {transactions.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center mt-10">
            ...
            <img className="h-[50vh] w-[50vh]" src={No_order} alt="No Order" />
            <button
