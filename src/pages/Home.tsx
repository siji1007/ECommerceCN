...
const HomePage: React.FC = () => {
  ...
  return (
    <div className='overflow-y-auto'>
      ...
      <div className="relative flex flex-col lg:flex-row items-center justify-center w-full h-auto bg-center text-left">
        <img
      ...
      <div className="relative flex flex-col lg:flex-row items-center justify-center w-full h-auto bg-center text-center">
      ...
      {/* Calaguas Section */}
      <div className="relative flex flex-col lg:flex-row items-center justify-start w-full h-auto bg-center text-left">
        <video
        ...
        <div className="relative z-10 p-4 sm:p-8 w-full lg:w-1/2 text-left">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-300">
            Calaguas Island in Camarines Norte is a serene tropical destination known for its powdery white sand beaches and clear blue waters, offering a perfect escape for camping, snorkeling, and swimming. Its unspoiled beauty and peaceful atmosphere make it a favorite for nature lovers and adventure seekers.
          </p>
        </div>
      </div>
    </div>
